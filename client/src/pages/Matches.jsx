    ...
    <div className="w-full">
      ...
      <div className="max-w-[1440px] mx-auto px-5 sm:px-margin-edge pt-md pb-xl w-full">
        ...
        <section className="mb-lg">
          ...
          <h1 className="bebas-headline text-4xl sm:text-display-sm text-on-surface uppercase leading-none mt-1">Live Global Stage</h1>
          ...
          <div className="flex items-center gap-sm overflow-x-auto no-scrollbar py-md">
            {TABS.map((t) => (
              <button
                ...
                className={`broadcast-toggle px-lg py-sm rounded-full font-label-caps text-label-caps whitespace-nowrap ${tab === t.key ? "active" : ""}`}
              >
                {t.label}
              </button>
            ))}
